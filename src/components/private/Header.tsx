...
export default function Header() {
  ...
  return (
    <header>
      ...
      <button className="md:hidden focus:outline-none transition-all delay-100 ease-in-out" onClick={toggleMenu} >
      ...
      <nav className="hidden md:flex md:items-center">
        <ul className="flex main-link">
          ...
          <li className="link">
            <Link to="https://github.com/bpsrm/React-Component" target="_blank" className="hover:text-blue">
              Source
      ...
      {showMenu &&
        <nav className="fixed inset-y-0 left-0 z-50 w-[70%] shadow-md bg-white text-black md:text-white md:hidden">
          <ul className="p-4 main-link">
            ...
            <li className="link">
              <Link to="https://github.com/bpsrm/React-Component" target="_blank" className="block hover:text-blue" >
                Source
                <i className="fa-solid fa-arrow-up-right-from-square"></i>
              </Link>
            </li>
